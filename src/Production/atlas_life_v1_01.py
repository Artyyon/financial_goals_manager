...
#   streamlit run "scr\Development\Atlas Life - v1.01.py"
#
# Observação importante sobre dados antigos:
# - Este app usa um NOVO banco SQLite por padrão: db/Production/atlas_life_production.db
...
# CONFIGURAÇÕES
# ---------------------------
DB_FILE = "db/Production/atlas_life_production.db"
...
def do_login_screen():
    ...
    with cols[1]:
        st.title("🛡️ Atlas Life v1.01 (Stable)")
...
def do_main_app():
    ...
    with st.sidebar:
        st.title(f"👤 {username}")
        st.caption("Atlas Life v1.01 (Stable)")
