# Atlas Life v0.6.0-dev — Gestão Financeira + Gestão de Metas
...
#   streamlit run "src\Development\Atlas Life - v0.6.0-dev.py"
#
# Observação importante sobre dados antigos:
# - Este app usa um NOVO banco SQLite por padrão: db/Development/atlas_life_v0.6.0-dev.db
...
# CONFIGURAÇÕES
# ---------------------------
DB_FILE = "db/Development/atlas_life_v0.6.0-dev.db"
...
def do_login_screen():
    ...
    with cols[1]:
        st.title("🛡️ Atlas Life v0.6.0-dev")
...
def do_main_app():
    ...
    with st.sidebar:
        st.title(f"👤 {username}")
        st.caption("Atlas Life v0.6.0-dev")
